...
python inner_loop_optimize.py --iteration {N} --n-trials 500 > iterations/iter{N}/optimization.log 2>&1 &
OPTIMIZE_PID=$!
...
3. Runs Bayesian optimization (up to 500 trials, early stopping if no improvement in 200-trial window)
