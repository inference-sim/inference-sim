...
type origCmdLevelVars struct {
	...
	// resolvedMCDir is the catalog entry directory resolveLatencyConfig writes as a side
	// effect (#1731 split it out of the former dual-role modelConfigFolder var).
	resolvedMCDir                                                                         string
	defaultsFile                                                                          string
	beta, alpha                                                                           []float64
...
func (o origCmdLevelVars) restore() {
	...
	modelConfigDir = o.resolvedMCDir
