...
func TestResolveLatencyConfig_EPRaisesAutoKVCapacity(t *testing.T) {
	...
	origUtil, origCatalogPath, origHW, origDefaults := gpuMemoryUtilization, catalogPath, hwConfigPath, defaultsFilePath
	t.Cleanup(func() {
		...
		gpuMemoryUtilization, catalogPath, hwConfigPath, defaultsFilePath = origUtil, origCatalogPath, origHW, origDefaults
	})
