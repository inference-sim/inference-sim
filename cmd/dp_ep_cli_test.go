...
// as every entry of a test catalog rooted at dir, plus a hardware config, returning
// the catalog root (for --catalog) and the hardware-config file path. Used by the
// DP/EP CLI validation tests.
