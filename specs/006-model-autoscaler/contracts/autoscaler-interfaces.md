...
Contract: Collector
  ...
  Must NOT:   Modify state; filter or threshold valid signals; return fewer models than are active or loading (structurally incomplete snapshots with empty Model/GPUType may be skipped)
