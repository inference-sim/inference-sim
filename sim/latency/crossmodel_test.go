...
// NOTE: Factory-path tests for crossmodel (TestNewLatencyModel_CrossModelMode,
// TestNewLatencyModel_CrossModelMode_MoE, and validation tests) were removed
// as part of #940: the crossmodel backend is no longer registered in the factory.
