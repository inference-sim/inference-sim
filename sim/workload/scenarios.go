...
func ScenarioUnfairTenants(seed int64, rate float64) *WorkloadSpec {
	return &WorkloadSpec{
		...
		Clients: []ClientSpec{
			...
			{ID: "high-priority-realtime", TenantID: "tenant-realtime", SLOClass: "realtime",
...
func ScenarioPrefixHeavy(seed int64, rate float64) *WorkloadSpec {
	return &WorkloadSpec{
		...
		Clients: []ClientSpec{
			...
			{ID: "unique-prefix", TenantID: "tenant-B", SLOClass: "interactive",
...
func ScenarioMixedSLO(seed int64, rate float64) *WorkloadSpec {
	return &WorkloadSpec{
		Version: "1", Seed: seed, Category: "language", AggregateRate: rate,
		Clients: []ClientSpec{
			{ID: "realtime", TenantID: "tenant-rt", SLOClass: "realtime",
			...
			{ID: "interactive", TenantID: "tenant-int", SLOClass: "interactive",
