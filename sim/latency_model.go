...
type LatencyModel interface {
	...
	// processing) that is NOT per-token. TrainedPhysicsModel uses α₁ = fixed post-decode
	// overhead per request. BlackboxLatencyModel and RooflineLatencyModel return 0.
