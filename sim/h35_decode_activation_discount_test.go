...
// TestH35_DecodeActivationDiscountNegligible validates the hypothesis that the
...
func TestH35_DecodeActivationDiscountNegligible(t *testing.T) {
	...
	fmt.Println("H35_ACTIVATION_FRACTION_START")
	...
	fmt.Println("H35_ACTIVATION_FRACTION_END")
	fmt.Printf("H35_MAX_ACTIVATION_FRACTION=%.6f%%\n", maxActivFraction)
	...
	fmt.Println()
	fmt.Println("H35_STEPTIME_START")
	...
	fmt.Println("H35_STEPTIME_END")
	fmt.Printf("H35_MAX_STEP_DELTA_075_VS_100=%.6f%%\n", maxStepDelta)
	fmt.Printf("H35_MAX_STEP_DELTA_BS=%d\n", maxStepDeltaBS)
	fmt.Printf("H35_MAX_STEP_DELTA_KV=%d\n", maxStepDeltaKV)
	...
	fmt.Println()
	fmt.Println("H35_FACTOR_SWEEP_START")
	...
	fmt.Println("H35_FACTOR_SWEEP_END")
	fmt.Printf("H35_GLOBAL_MAX_DELTA=%.6f%%\n", globalMaxDelta)

	// ========================================================================
	// Phase 4: Summary and Verdict
	// ========================================================================
	fmt.Println()
	fmt.Println("H35_VERDICT_START")
	...
	for _, bs := range []int{1, 8, 64} {
		for _, kvLen := range []int64{512, 2048} {
			...
			activBytesRecon := activBytes075 * (0.75 / 0.75) // identity
