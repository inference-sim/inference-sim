...
func TestExampleConfigs_EPPEstimatePrefix_RoutingBehavior(t *testing.T) {
	...
	policy := NewRoutingPolicy(bundle.Routing.Policy, bundle.Routing.Scorers, 16, nil, nil)
...
func TestExampleConfigs_EPPPrecisePrefix_QueueDepthMonotonicity(t *testing.T) {
	...
	policy := NewRoutingPolicy("weighted", []ScorerConfig{{Name: "queue-depth", Weight: 1.0}}, 16, nil, nil)
	snapshots := []RoutingSnapshot{
...
func TestExampleConfigs_EPPPrecisePrefix_KVUtilizationMonotonicity(t *testing.T) {
	...
	policy := NewRoutingPolicy("weighted", []ScorerConfig{{Name: "kv-utilization", Weight: 1.0}}, 16, nil, nil)
	snapshots := []RoutingSnapshot{
