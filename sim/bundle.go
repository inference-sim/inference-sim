...
var (
	...
	validRoutingPolicies   = map[string]bool{"": true, "round-robin": true, "least-loaded": true, "weighted": true, "adaptive-weighted": true, "kv-adaptive": true, "prefix-affinity": true, "always-busiest": true}
