...
var (
	...
	validRoutingPolicies   = map[string]bool{"": true, "round-robin": true, "least-loaded": true, "weighted": true, "adaptive-weighted": true, "prefix-affinity": true, "always-busiest": true}
