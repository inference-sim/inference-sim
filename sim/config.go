...
type ModelHardwareConfig struct {
	ModelConfig ModelConfig   // HuggingFace model parameters (for roofline/trained-physics modes)
	HWConfig    HardwareCalib // GPU specifications (for roofline/trained-physics modes)
