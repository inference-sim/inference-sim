...
func newTestDeploymentConfig(numInstances int) DeploymentConfig {
	return DeploymentConfig{
		SimConfig: sim.SimConfig{
			...
			BatchConfig:         sim.NewBatchConfig(256, 2048, 0, 0, 0),
...
func TestDeploymentConfig_ToSimConfig_ReturnsEmbeddedSimConfig(t *testing.T) {
	dc := DeploymentConfig{
		SimConfig: sim.SimConfig{
			...
			BatchConfig:         sim.NewBatchConfig(128, 4096, 512, 0, 0),
		...
		t.Run(tc.Model, func(t *testing.T) {
			config := DeploymentConfig{
				SimConfig: sim.SimConfig{
					...
					BatchConfig:         sim.NewBatchConfig(tc.MaxNumRunningReqs, tc.MaxNumScheduledTokens, tc.LongPrefillTokenThreshold, 0, 0),
