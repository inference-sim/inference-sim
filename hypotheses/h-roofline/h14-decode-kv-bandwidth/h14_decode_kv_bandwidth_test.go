...
// TestH14_DecodeKVBandwidthDiscount validates the hypothesis that the 0.80
...
func TestH14_DecodeKVBandwidthDiscount(t *testing.T) {
	...
	fmt.Println()
	fmt.Println("H14_STEPTIME_START")
	...
	fmt.Println("H14_DISCOUNT_SWEEP_END")
}
