# Reproduction Guide: idea-2-total-context-model (Round 3)
...
- **Date:** 2026-02-27 21:05:35

## Step 1: Create isolated worktree

```bash
git worktree add ../reproduce-idea-2-total-context-model 31f4eb9e0465abcdd0bf47aefac518b7a5292c55 --detach
cd ../reproduce-idea-2-total-context-model
```
...
cp -r hypotheses/h-stepml/round3/idea-2-total-context-model/ hypotheses/h-stepml/round3/idea-2-total-context-model/
...
```bash
git apply hypotheses/h-stepml/round3/idea-2-total-context-model/go_changes.patch
...
cd hypotheses/h-stepml/round3/idea-2-total-context-model
