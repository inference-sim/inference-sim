...
**Controlled variables:** Model (llama-3.1-8b-instruct), instances (4), seed (42), workload (500 multi-turn chat requests at 2000 req/s), routing, scheduler, KV config, tracing
**Varied variable:** Admission policy (token-bucket vs always-admit)
