...
RD = sys.argv[1] if len(sys.argv) > 1 else "hypotheses/h-bursty/results"
SEEDS = [42, 123, 7777]
...
print("=" * 70)
print("Iter 18: Bursty Arrivals (Gamma CV=2.0, rate=2000, 8 instances)")
print("=" * 70)
rr_p99 = None
for pol in ["rr", "baseline", "compound"]:
    vals = []
    for seed in SEEDS:
    ...
    if vals:
        ...
        print(f"  {pol:<16} P99: {ap:>9.2f}ms  mean: {am:>9.2f}ms  comp: {ac:>5d}{tag}")
    else:
        print(f"  {pol:<16} N/A")
