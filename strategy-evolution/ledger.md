...
| 10 | Multi-turn session workload | Crit: **-29.2%** (52.7→37.3ms) | ~0% | 1.35x | Strategy works on multi-turn with context accumulation | Sheddable IMPROVED (-21%) on multi-turn |
