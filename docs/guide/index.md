...
| [Latency Models](latency-models.md) | Choosing between roofline (default, analytical), blackbox (data-driven), and trained-physics (physics-informed) step time estimation |
