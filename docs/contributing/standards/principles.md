...
|---------|-----------------|----------------|
| Antipattern rules (R1-R23) | `docs/contributing/standards/rules.md` | CLAUDE.md (pointer), CONTRIBUTING.md (checklist), `.github/PULL_REQUEST_TEMPLATE.md` (PR checklist), `docs/contributing/templates/micro-plan.md` (sanity checklist), `docs/contributing/index.md` (landing page table), `docs/guide/skills-and-plugins.md` (rules count) |
| System invariants (INV-1–INV-19, plus INV-A, INV-A2, INV-W3, INV-BC-DP1, INV-L1–INV-L7, INV-PD-* and INV-P2-*) | `docs/contributing/standards/invariants.md` | CLAUDE.md (summary), `docs/concepts/core-engine.md` (formulas), `docs/concepts/architecture.md` (signal freshness), CONTRIBUTING.md (count), `docs/contributing/index.md` (landing page table), `mkdocs.yml` (nav label), `.github/PULL_REQUEST_TEMPLATE.md` (INV-1 checklist), `.github/ISSUE_TEMPLATE/bug_report.md` (INV-1 formula), `docs/contributing/templates/micro-plan.md` (sanity checklist), `docs/contributing/hypothesis.md` (INV-1 formula), `.claude/skills/hypothesis-experiment/SKILL.md` (INV-1 formula) |
...
| Body-vs-comments authority (which issue comments refine the body) | `docs/contributing/pr-workflow.md` (Step 1.5) | CLAUDE.md (summary), `docs/contributing/automated-delivery.md` (L1 restatement), `docs/contributing/issue-comment-authority.md` (decision record — reasoning and rejected alternative), CONTRIBUTING.md (journey step), `scripts/README.md` (script entry), `scripts/deliver-issue-refinements.jq` (the mechanical half: which comments count) |
