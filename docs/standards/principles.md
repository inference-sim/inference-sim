...
| Experiment standards | `docs/standards/experiments.md` | — (note: review protocol subsection references `hypothesis.md` as canonical) |
| Hypothesis experiment workflow | `docs/process/hypothesis.md` | CONTRIBUTING.md (summary), hypotheses/README.md (step list), MEMORY.md (protocol section) |
