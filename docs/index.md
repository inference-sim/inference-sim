...
- **Pluggable latency models** — roofline (default, analytical FLOPs/bandwidth), blackbox (data-driven coefficients), and trained-physics (physics-informed, MoE-aware, roofline × learned corrections), with an extensible interface for custom backends
