...
# NS-6 (#1733) + S4 (#1731) — three rules every `blis run`/`blis replay` example below obeys:
...
#     <catalog>/<short-name>/config.json; an uncatalogued model is REFUSED naming the path
#     its entry belongs at. No run-time HuggingFace fetch, and no run/replay/observe
